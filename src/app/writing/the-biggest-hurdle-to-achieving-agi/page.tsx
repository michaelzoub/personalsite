  ...
  return (
    <main className="article-page">
      ...
      <header className="article-hero" id="top">
        ...
        <img src="/writing/agi/cover.jpg" alt="Cover artwork for The biggest hurdle to achieving AGI" />
      </header>
      ...
      <article className="article-body">
        ...
        <Figure src="/writing/agi/03.jpg" alt="Voyager performance in Minecraft" />
        ...
        <Figure src="/writing/agi/04.jpg" alt="Voyager iterative prompting mechanism" />
        ...
        <Figure src="/writing/agi/05.jpg" alt="Voyager automatic curriculum and skill library" />
        ...
        <Figure src="/writing/agi/06.png" alt="Go-Explore principles" />
        ...
        <Figure src="/writing/agi/07.png" alt="Go-Explore benchmark results" />
        ...
        <Figure src="/writing/agi/08.png" alt="Automated research paper cover" />
        ...
        <Figure src="/writing/agi/11.jpg" alt="ReAct benchmark performance" />
        ...
        <Figure src="/writing/agi/14.png" alt="Goodhart's law and objective exploitation" />
