...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center p-4 bg-white text-black h-fit md:overflow-hidden md:h-screen">
      ...
      <div className="asbolute m-14 md:bottom-0 m-2">© 2024 MIT Licensed</div>
    </main>
  )
}
